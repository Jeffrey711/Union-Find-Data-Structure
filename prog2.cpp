...
int main(int argc, char *argv[]) {
	...
	while (count < edges) {
		//Read in edge nodes (a,b) and weight, w
		cin >> a;
		cin >> b;
		cin >> w;
	...
	//Uncomment to print time to execute program
	/*t = clock() - t; //Stop timing
	float s = (float) t; //Convert to float
	s = s / CLOCKS_PER_SEC; //Convert from clicks
	cout << "Ran for: " << s << " seconds" << endl;
	*/
}